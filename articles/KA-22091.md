...
# Error en la canalización. &quot;Falta la propiedad end_aem_createsegmentstore&quot;

## Descripción {#description}

La canalización de CI/CD sigue fallando durante la fase de &quot;Implementación en desarrollo&quot;. <br><br>Los registros de implementación no mostraron ningún error debido a la base de código, pero están presentes los siguientes errores:<br><br> <br><br> <br><br> <br><br>`[` 1`]`  
...
Al comprobar la canalización, se pudo ver que falla con el error &quot;errorCode&quot;: &quot;BLOCKED_QUEUE&quot;.

Esto significa que la cola de replicación está bloqueada y dificulta la instalación de contenido mutable adicional.

En los registros, los errores `[` 1`]`  están presentes durante el periodo de tiempo de implementación. Lo más probable es que el nodo - `[` 2`]`  no está presente en el editor o en el servidor de vista previa y la replicación falla.
