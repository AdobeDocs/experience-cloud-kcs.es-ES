---
title: 'Error de canalización: "Falta la propiedad end_aem_createsegmentstore"'
description: 'Aprenda a solucionar el problema en el que se produce un error: falta la propiedad end_aem_createsegmentstore en Adobe Experience Manager.'
solution: Experience Manager
product: Experience Manager
applies-to: Experience Manager
keywords: AEM KCS, Canalización,, CI/CD, Error
...
# Error de canalización: &quot;Falta la propiedad end_aem_createsegmentstore&quot;


&quot;Cuando se produce un error en la canalización: `The end_aem_createsegmentstore property is missing`, siga las instrucciones que se proporcionan en este artículo para solucionar el problema.&quot;
...
El <b>Integración continua</b> y <b>Implementación continua</b> <b>(CI/CD)</b> la canalización sigue fallando durante la *Implementar en desarrollo* escenario.
<br>Los registros de implementación no mostraron ningún error debido a la base de código, pero están presentes los siguientes errores:<br> <br>`[` 1`]`  
...
Al comprobar la canalización, se puede ver que falla con el error *errorCode*: *BLOCKED_QUEUE*.

Esto significa que la cola de replicación está bloqueada y dificulta la instalación de contenido mutable adicional.

En los registros, los errores <b>`[` 1`]` </b> están presentes durante el periodo de tiempo de implementación. Lo más probable es que el nodo - <b>`[` 2`]` </b> no está presente en el editor o en el servidor de vista previa y la replicación falla.

Después de borrar la cola de replicación, la implementación de la canalización se realizó correctamente.
