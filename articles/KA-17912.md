---
title: "Comprender el almacenamiento en caché | AEM"
description: '"Descubra cómo se produce el almacenamiento en caché de Dispatcher y cómo se puede configurar en Adobe Experience Manager".'
solution: Experience Manager
product: Experience Manager
applies-to: "Experience Manager"
keywords: AEM "KCS, Almacenamiento en caché, Almacenamiento en caché de Dispatcher,, Experience Manager"
...
# Explicación del almacenamiento en caché | AEM


En este artículo, aprenderá cómo se produce el almacenamiento en caché de Dispatcher y cómo puede configurarlo utilizando los siguientes directorios de caché predeterminados en sus instalaciones de línea de base:
...
Queremos hacer que nuestro sitio publicado sea lo más voraz posible y almacenar todo en caché.
