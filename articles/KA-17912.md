...
[&lt;- Anterior: Explicación de los archivos de configuración](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17477.html)
...
Ahora, cuando el despachante vea la solicitud, ignorará el hecho de que la solicitud tiene el valor `query` parámetro de `?` referencia y almacenar en caché la página
...
Una característica más reciente del módulo de Dispatcher era `Time To Live (TTL)` opciones de invalidación basadas en elementos en caché. Cuando un elemento se almacena en caché, busca la presencia de encabezados de control de caché y genera un archivo en el directorio de caché con el mismo nombre y un `.ttl` extensión.
...
[Siguiente -> Uso y comprensión de las variables](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17487.html)