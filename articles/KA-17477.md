...
![orden de inclusión de apache baseline. el binario de apache comienza con httpd.conf, que hace un include opcional a conf.d/*.conf y conf.module.d/* Directorios .conf](https://helpx.adobe.com/content/dam/kb/en/ams-dispatcher-manual/Apache-Webserver-Baseline-Includes.png)
...
![los hosts virtuales de ams incluyen subelementos. Esta imagen muestra cómo un archivo .vhost incluye archivos de variables, listas blancas y carpetas de reescritura](https://helpx.adobe.com/content/dam/kb/en/ams-dispatcher-manual/Apache-Webserver-AMS-Vhost-Includes.png)
