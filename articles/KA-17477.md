...
[&lt;- Anterior: Diseño de archivo básico](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17502.html)
...
![Esta imagen muestra cómo un archivo .vhost incluye archivos de variables, listas blancas y carpetas de reescritura](assets/Apache-Webserver-AMS-Vhost-Includes.png "Apache-Webserver-AMS-Vhost-Includes")
...
![<FILENAME>_farms.any incluirá archivos sub.any para completar una configuración de granja.  En esta imagen puede ver que una granja incluirá cada caché de archivos de sección de nivel superior, encabezados de clientes, filtros, renderizadores y archivos vhosts.any](assets/Apache-Webserver-AMS-Farm-Includes.png "Apache-Webserver-AMS-Farm-Includes")
...
[Siguiente -> Comprender la caché](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17912.html)