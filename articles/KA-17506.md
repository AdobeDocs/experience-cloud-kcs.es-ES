...
- Utilice un filtro de visualización en el puerto del SMS-C.<br>\
...
- Utilice la variable<b>Seguir flujo TCP</b> para aislar el flujo en el que está trabajando.<br>\
