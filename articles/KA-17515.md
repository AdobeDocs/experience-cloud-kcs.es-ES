...
*Este artículo se proporciona únicamente como guía de ejemplo general. Debe ponerse en contacto con el equipo de cuentas de Adobe de Adobe Campaign para medir el tamaño exacto de la implementación antes de iniciar el proyecto de Campaign. <b>No</b> adquiera o implemente cualquier infraestructura o hardware hasta que esto se haga.*
...
<br>Escenario 1: Implementación de tamaño moderado<br>
...
<br>Escenario 2: Implementación de gran tamaño<br>
...
<br>Escenario 3: Implementación empresarial con centro de mensajes<br>
