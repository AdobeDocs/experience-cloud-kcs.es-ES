...
description: AEM Obtenga información sobre cómo resolver el problema de la en el que no puede cargar la consola de recursos DAM en Author. Limpiar instancias de flujo de trabajo.
solution: Experience Manager
product: Experience Manager
applies-to: Experience Manager
keywords: AEM "KCS, no se puede cargar la consola de recursos DAM, el autor, el flujo de trabajo, el flujo de trabajo"
...
AEM Si ve una pantalla en blanco al acceder a la consola de recursos de la interfaz de usuario en Autor, podría deberse a demasiadas instancias de flujo de trabajo que llevan a un error `[` 1`]` . Puede resolverlo limpiando estas instancias.
...
AEM Al intentar acceder a la consola de recursos mediante la opción &quot;&quot;`/assets.html/content/dam`&quot; la pantalla está en blanco.
...
Error al comprobar el registro de errores `[` 1`]`  se ha encontrado.

Las IU de recursos y sitios deben buscar el estado del flujo de trabajo de los elementos que están listando. Por lo tanto, si hay demasiadas instancias de flujo de trabajo, la página no se carga y genera un error `[` 1`]`  estará presente en los registros.
