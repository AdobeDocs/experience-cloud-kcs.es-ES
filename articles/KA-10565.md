---
title: No se puede conectar con Brand Portal con el error "JWT ha caducado" | AEM
...
Después de configurar la integración de AEM Assets con Brand Portal, aquí en [Descripción general de Experience Manager Assets Brand Portal: Configuración de Experience Manager Assets con Brand Portal](https://experienceleague.adobe.com/en/docs/experience-manager-brand-portal/using/introduction/brand-portal#configure-brand-portal) AEM en la documentación de,
