...
keywords: KCS, Connect, Brand Portal AEM, agente de replicación, JWT ha caducado, Error de,, Adobe Experience Manager, 6.2
...
2. Cambie la hora a una hora válida o use ntp.
