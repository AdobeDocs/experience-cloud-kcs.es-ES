...
El cliente informa de un mensaje que no está internacionalizado. El mensaje de error &quot;Invalid date - The value must be of date&quot; está en inglés aunque deba estar en alemán, que es el idioma del explorador del cliente.
