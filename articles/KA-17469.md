...
1. <b>Instale el último CFP/SP de.</b>
   ...
   Puede encontrar las correcciones rápidas más recientes en [Uso compartido de paquetes Adobe](https://experience.adobe.com/#/downloads/content/software-distribution/es/aem.html).
