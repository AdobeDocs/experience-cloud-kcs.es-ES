...
[&lt;- Anterior: ¿Qué es Dispatcher?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17911.html)

## Descripción

Este documento explicará el conjunto de archivos de configuración estándar de AMS y el pensamiento detrás de este estándar de configuración
...
### Directorio de configuración específica del módulo Dispatcher
...
Como el ejemplo perfecto al añadir el módulo de Dispatcher a Apache, crearía un módulo `.so` en ` /etc/httpd/modules/` y luego inclúyalo añadiendo un archivo en `/etc/httpd/conf.modules.d/02-dispatcher.conf` con el contenido para cargar el módulo `.so` file
...
[Siguiente -> Explicación de los archivos de configuración](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17477.html)