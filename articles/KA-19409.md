...
keywords: KCS,Alternativa a la actividad Recolector de ficheros en ACS
...
La Transferencia de archivos permite descargar varios archivos basados en el patrón de nombre de archivo de un servidor externo. Cada archivo se pasa a la actividad Load File, lo que proporciona datos a la actualización.

Una vez finalizado, continúa con el siguiente archivo, etc.

La opción Transferencia de archivos también incluye la opción Historización, tal como se encuentra en Recolector de archivos.

Este es un ejemplo de registro de ejecución de flujo de trabajo que procesa cuatro archivos desde la descarga para insertar datos en el esquema.
