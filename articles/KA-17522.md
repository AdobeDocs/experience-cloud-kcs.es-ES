---
title: "Cómo configurar Adobe I/O: Authentication: paso a paso"
...
# Cómo configurar Adobe I/O: Authentication: paso a paso

## Descripción

<br>Este documento le explica cómo crear los certificados, las claves y los tokens para la ejecución.<br><br><br><br><br>Objetivo<br><br><br><br> <br><br>
Proporcionar pasos claros y reproducibles para generar un token de portador de Adobe I/O para ejecutar llamadas a la API de soluciones DMA como [!DNL Target].


## Resolución

<br><br>Pasos<br><br><br><br> <br><br>
<b>Pasos para crear un token de portador para ejecutar las llamadas a la API de Adobe I/O:</b>
...
- <b>Genere la clave privada y el certificado público según la siguiente documentación:</b> https://www.adobe.io/apis/cloudplatform/console/authentication/createcert.html
   ...
   En un Mac, los siguientes comandos están incorporados en el terminal. 

   En un ordenador, tiene que descargar [!DNL Cygwin] (u otra herramienta de preferencia personal) y ejecutarlo desde la línea de comandos. Estos son los pasos para descargar e instalar [!DNL Cygwin]:

   1. Vaya a https://cygwin.com/install.html
   2. Descargue y ejecute `setup-x86_64.exe`

   <b>*Nota</b>: su directorio de inicio es: `C:\cygwin64\home\WINDOWSUSER`
...
<br> 
    ...
    &lt;b>Nota&lt;/b>: le hace varias preguntas que debe rellenar para generar el certificado. Vea la siguiente captura de pantalla:
![rtaImage](https://helpx.adobe.com/content/dam/help/en/marketing-cloud-core/kb/adobe-io-authentication-step-by-step/jcr%3acontent/main-pars/procedure/proc_par/step_0/step_par/image/rtaImage.png "rtaImage")<br> 
    ...
    Una vez creados los archivos, convierta `secret.key` en &quot;secret.pem&quot; con el siguiente comando:
<br> <br> <br>
...
<br> 
    ...
    Aquí están los archivos que se crean en su sistema de archivos (en este punto, puede moverlos a otra ubicación en su equipo para mantenerlos organizados):
![rtaimage_1_](https://helpx.adobe.com/content/dam/help/en/marketing-cloud-core/kb/adobe-io-authentication-step-by-step/jcr%3acontent/main-pars/procedure/proc_par/step_0/step_par/image_747173003/rtaimage_1_.png "rtaimage_1_")
    ...
    los archivos se generan en su directorio personal: `C:\cygwin64\home\WINDOWSUSER`


- <b>Crear integración dentro de la consola de Adobe I/O:</b>
...
- Seleccione la opción &quot;Acceder a una API&quot; y haga clic en &quot;Continuar&quot;.
...
- Seleccione la solución de Adobe (actualmente sólo disponible para [!DNL Target]).
...
- Cuando se haya completado el procesamiento, haga clic en &quot;continuar con los detalles de la integración&quot;.

![rtaimage_9_](https://helpx.adobe.com/content/dam/help/en/marketing-cloud-core/kb/adobe-io-authentication-step-by-step/jcr%3acontent/main-pars/procedure/proc_par/step_1/step_par/image_1642793077/rtaimage_9_.png "rtaimage_9_")<br>     ¡Éxito! Ha creado una integración.
...
- <b>Genere el token web JSON (JWT):</b>
En la interfaz de usuario de integración, haga clic en la pestaña JWT, pegue la clave privada, haga clic en el botón Generar JWT (véase la captura de pantalla): generar JWT - entrada.
...
- <b>Intercambio del JWT por un token de acceso al portador:</b>
   ...
   *Nota: si se ejecuta en un terminal de Mac, la respuesta parece quedar truncada. En su lugar utilice [!DNL Postman].*

   - Descargue e instale la herramienta gratuita API llamada &quot;[!DNL Postman]&quot; (disponible en Mac, [!DNL Windows], o [!DNL Linux]): [https://www.getpostman.com/](https://www.getpostman.com/)
   - Importe esta llamada a la API a [!DNL Postman] copiando el código de abajo en un archivo de texto en su ordenador con una extensión `.json`:
...
- Importe el archivo a [!DNL Postman] yendo a importar archivo: puede arrastrar y soltar el archivo `.json` aquí o buscarlo.
...
- Esto crea una &quot;colección&quot; en [!DNL Postman] en el lado izquierdo, con una llamada a la API con el nombre &quot;Intercambiar JWT por token de portador&quot;.
...
- Haga clic en la llamada a la API &quot;Intercambiar JWT por token de portador&quot;.
...
![rtaimage_16_](https://helpx.adobe.com/content/dam/help/en/marketing-cloud-core/kb/adobe-io-authentication-step-by-step/jcr%3acontent/main-pars/procedure/proc_par/step_3/step_par/image_287339656/rtaimage_16_.png "rtaimage_16_")<br> 
    ...
    Nota: como se destaca en rojo arriba, estoy en la pestaña &quot;Cuerpo&quot;. Si se encuentra en otra pestaña, no verá los tres datos necesarios.
...
- <b>Ejemplo de llamada a la API:</b>
   ...
   - [!DNL Target]
   - Ejecutar la llamada [!DNL Target] con el token de acceso
