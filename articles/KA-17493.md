...
keywords: KCS, Mecanismo de vaciado de caché, Flujo de trabajo de Dispatcher, Agentes de replicación, Proceso de activación, Gestión de solicitudes de vaciado, Tipo de serialización, Configuración de Dispatcher, Método HTTP para solicitudes de vaciado, Estructura del archivo estático, Protocolo de enlace de marca de tiempo, Ejemplos de protocolos de enlace de caché, Configuración del archivo de granja
