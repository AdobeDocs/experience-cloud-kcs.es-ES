...
5. Repita el tercer paso con una consulta para el usuario anónimo: `/jcr:root/home/users//element(*,rep:User)@rep:principalName="anonymous"`.
...
2. Suba el archivo jar al servidor de AEM.
3. Detenga AEM (instancias de origen y destino).
...
7. A continuación, ejecute el comando en el shell del servidor: 
   ...
   ```
8. Una vez finalizado, vaya al tercer paso para migrar las ACL.  Si no puede migrar usando Crx2Oak, siga los pasos de migración de paquetes que se indican a continuación.
...
6. Seleccione la pestaña Avanzado (véase la captura de pantalla siguiente).
7. En el menú desplegable de AC Handling, seleccione <b>Fusionar</b> para evitar eliminar las ACL existentes en el sistema de destino.
