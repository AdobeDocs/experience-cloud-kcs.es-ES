...
[&lt;- Anterior: Vaciado de Dispatcher](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17493.html)
...
![Menú desplegable del cuadro de diálogo para AEM IU de creación en la pantalla del editor del sitio](assets/aem-page-properties-drop-down.png "aem-page-properties-drop-down")![página de diálogo de propiedades de página de aem](assets/aem-page-properties.png "aem-page-properties")

#### Buscador de contenido clásico:

![AEM propiedades de la página de la barra de tareas clásica de siteadmin](assets/aem-page-properties-sidekick.png "aem-page-properties-sidekick")![Cuadro de diálogo de propiedades de página de la IU clásica](assets/aem-page-properties-classic.png "aem-page-properties-classic")
...
![captura de pantalla de la consola de una entrada mnemónica en las reglas de resolución de recursos](assets/vanity-resource-resolver-entry.png "vanity-resource-resolver-entry")
...
![captura de pantalla del contenido representado en /libs/granite/dispatcher/content/vanityUrls.html](assets/vanity-url-component.png "vanity-url-component")
...
[Siguiente -> Registro común](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17914.html)