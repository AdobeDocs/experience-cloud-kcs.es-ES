---
title: "El tamaño de un campo de encabezado de solicitud supera el límite del servidor"
description: AEM "Aprenda a resolver el error \"Solicitud incorrecta\" al abrir una página en el."
solution: Experience Manager as a Cloud Service,Experience Manager
product: Experience Manager as a Cloud Service,Experience Manager
applies-to: "Experience Manager as a Cloud Service,Experience Manager"
keywords: AEM "KCS, tamaño, encabezado de solicitud, exceder, límite del servidor,, Adobe Experience Manager, resolución de problemas, AEMaaCS, Adobe Experience Manager as a Cloud Service"
...
# El tamaño de un campo de encabezado de solicitud supera el límite del servidor


Aumente el valor de `#LimitRequestFieldSize` y `#LimitRequestLine` para versiones de AMS/locales. Aumente el <b>Encabezado de solicitud</b> Limite el problema añadiendo también esas propiedades en los archivos Vhost para AEMaaCS.
...
Al abrir una página, los usuarios reciben un &quot;<b>Solicitud incorrecta</b>&quot; respuesta con el mensaje:

&quot;<b>*El tamaño de un campo de encabezado de solicitud supera el límite del servidor</b>*&quot;
...
Apache has a default `LimitRequestLine` of *8K*. Para obtener más información, consulte [Funciones principales de Apache: Directiva LimitRequestLine](https://httpd.apache.org/docs/2.4/en/mod/core.html#limitrequestline) en el sitio web de Apache.

Este error se puede superar aumentando el valor de `#LimitRequestFieldSize` y `#LimitRequestLine`.

<u>Para AMS/On-Prem</u>:

El límite de encabezados se puede aumentar en el archivo de configuración de Apache: `httpd.conf`.



<u>Para AEMaaCS</u>:

Aumente el límite del encabezado de la solicitud añadiendo las propiedades anteriores a los archivos Vhost:
