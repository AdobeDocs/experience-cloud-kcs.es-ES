...
<b>Herramienta de volcado de procesos para Adobe Experience Manager</b>

Si utiliza un producto de Adobe Experience Manager, puede instalar [esta herramienta](https://helpx.adobe.com/experience-manager/kb/thread-dumps-collection-analysis.html) para tener una interfaz de usuario sencilla para generar volcados de procesos.
