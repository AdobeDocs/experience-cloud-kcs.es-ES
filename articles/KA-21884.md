...
# Adobe Experience Manager: Lista de páginas publicadas con la API de Query Builder

## Descripción {#description}


Este artículo explica cómo enumerar las páginas publicadas en un autor AEM.
...
Usando la API de Query Builder, busque las páginas con cq:lastReplicationAction = Activate.
...
La ejecución de la consulta para una ruta de contenido que tiene muchas páginas en ella puede causar un problema de rendimiento. Se recomienda reducir la ruta y ejecutar la consulta varias veces en lugar de intentar recuperar todos los datos en una sola ejecución de consulta.
