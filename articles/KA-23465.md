...
La cola de replicación se bloquea periódicamente para uno de nuestros clientes de AEMaaCS. En este artículo se describe la solución sugerida por el equipo de ingeniería que se puede realizar en la interfaz de usuario con permisos de administrador.
...
Una de nuestras colas de replicación de clientes de AEMaaCS se bloquea periódicamente debido a la excepción javax.jcr.NamespaceException: prefijo de espacio de nombres desconocido: ns22_ exception.
...
Para desbloquear la cola, basta con eliminar la solicitud de la interfaz de usuario de la cola de distribución de publicación dorada. Sugiera al cliente que siga estos pasos.
