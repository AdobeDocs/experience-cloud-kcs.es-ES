...
keywords: KCS, Cloud Manager, Generar paquete Maven
...
<b>Entorno</b><br><br>Cloud Manager (Adobe Experience Manager)<br><br> <br><br><b>Problema/Síntoma</b>
...
2. Añada esta versión del nodo como <b>devDependencies</b> en el archivo `package.json` del módulo que no se pudo crear. En el ejemplo anterior, es UI Frontend.    ANTES - `package.json`:
