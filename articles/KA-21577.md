...
2. Añada esta versión del nodo como <b>devDependencies</b> en el archivo `package.json` del módulo que no se pudo crear. En el ejemplo anterior, es UI Frontend.
