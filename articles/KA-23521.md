...
description: Obtenga información sobre cómo resolver problemas con la función de mover página, lo que provoca un error en la eliminación o publicación debido a problemas con la recuperación de referencias de fragmentos de contenido.
solution: Experience Manager
product: Experience Manager
applies-to: Experience Manager 6.5
keywords: KCS, función Mover página, eliminación, problemas de recuperación de referencia, cliente de AMS, asistencia del CSE, reindexar, fragmento de contenido, publicación
