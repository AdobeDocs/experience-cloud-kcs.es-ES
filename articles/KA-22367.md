...
AEM AEM Después de crear la configuración de SAML 2.0 para habilitar el inicio de sesión SSO en su producción de Autor, el cliente recibió un mensaje de error del lado del cliente después de que el proveedor de Azure realizara el inicio de sesión y recuperara el token SAML, para realizar la autenticación del lado del.<br><br> <br><br>El error recibido fue `[` 1`]` <br><br> <br><br><b>`[` 1`]`  \*ERROR\* `[` qtp1558388453-153215`]`  El parámetro de respuesta SAML de com.adobe.granite.auth.saml.SamlAuthenticationHandler no se ha proporcionado o no es válido.</b>
...
El error 403 suele aparecer si el filtro de referente de Apache Sling no está activado. Al comprobar la configuración del Filtro de referente de Apache Sling, la opción &quot;Permitir vacío&quot; no se activó y tampoco se añadió ningún host a &quot;Permitir hosts&quot;
...
Después de completar estos pasos necesarios, marque &quot;Permitir vacío&quot; y luego añada los hosts que representan al proveedor de IdP a &quot;Permitir hosts&quot;, el inicio de sesión se realizó correctamente.



NOTA:

La URL de IDP debe añadirse a la configuración del filtro de referente de Apache Sling sin incluir el protocolo, por ejemplo aem-sso-saml en lugar de https://aem-sso-saml
