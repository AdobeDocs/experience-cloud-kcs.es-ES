...
donde la ruta del nodo corrupto es la ruta obtenida en el paso 2, por ejemplo: &quot;/content/dam/test.txt/jcr:content/renditions/original/jcr:content/&quot; Nota: Cuando use la versión 1.6.13 y superiores de oak-run.jar, establezca el parámetro JVM —read-write si encuentra un error como:
...
1. Realice una limpieza de puntos de comprobación enumerando los siguientes puntos. Si hay más de un punto de comprobación, límpielos:
   ...
   ```
2. Ejecute una compactación fuera de línea.  Si no sabe cómo ejecutar la compactación sin conexión, consulte [aquí](https://gist.github.com/andrewmkhoury/0b1fe4d8b619178ff87b).
3. Inicie el servidor y espere a que se complete la indexación.
