---
title: "No se puede seleccionar Adobe Target como solución de nube para una configuración de IMS"
...
# No se puede seleccionar Adobe Target como solución de nube para una configuración de IMS
...
AEM Entorno: local de la aplicación



El cliente está intentando crear una configuración de IMS de Adobe Target AEM Adobe Target para integrar a los usuarios con la configuración de IMS de.

Sin embargo, cada vez que seleccionan &quot;Adobe Target&quot; como solución de nube para la configuración de IMS, aparece el error &quot;No se pueden recuperar los certificados: el userId proporcionado no identifica un usuario existente&quot; y no se puede crear la configuración.

Este problema solo se produce para la solución de Adobe Target.



Pasos a seguir:

1. Ir a Herramientas `>`  Seguridad `>`  Configuraciones de IMS `>`  Crear
2. Seleccione Target como solución

Recibirá un error en la interfaz de usuario &quot;No se puede recuperar el certificado. El ID de usuario proporcionado no identifica a un usuario existente.&quot;

En los registros, el único error relacionado con este problema es `[` 1`]` .
...
Al comprobar los permisos de los usuarios &quot;target-imsconfig-service&quot; y &quot;targetservice&quot;, se observó que target-imsconfig-service no tenía ninguna ACE asignada.
...
Ruta: /home/users/system/target-imsconfig-service

Permiso: permitir

Privilegios: jcr:read; rep:write
