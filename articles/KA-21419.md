...
<b>Descripción</b>: la ejecución de la canalización falla durante el paso de la versión debido a errores en el código ui.frontend
...
- Localice en la raíz del repositorio de git el archivo pom.xml y busque la versión del nodo,
por ejemplo: nodeVersionv10.13.0/nodeVersion

- ui.frontend/package.json y añada el objeto devDependencies ya presente:
por ejemplo:
...
Nota:
1. No se debe copiar la “v” de la palabra “nodeVersionv10.13.0”.
2. La versión del nodo podría ser diferente en su caso. Por ejemplo, 12.22.7
