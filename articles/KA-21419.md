---
title: "La implementación de la canalización está fallando durante el paso de compilación"
...
# La implementación de la canalización falla durante el paso de compilación

## Descripción {#description}


<b>Descripción</b> : La ejecución de la canalización está fallando durante el paso de compilación debido a errores en el código ui.frontend

Se observan mensajes ERROR como el que se muestra a continuación en el archivo build.log:
...
- localice en la raíz de la repo de git el archivo pom.xml y busque la versión del nodo por ejemplo: nodeVersionv10.13.0/nodeVersion

- ui.frontend/package.json y agregue el objeto devDependencies ya presente: por ejemplo:
...
Nota:
1. no se debe copiar la v de nodeVersionv10.13.0.
2. la versión del nodo puede ser diferente en su caso. Por ejemplo: 12,22,7
