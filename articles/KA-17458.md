...
5. <b>Páginas de error de caché</b> - Aproveche el <b>[DispatcherPassError 1](https://helpx.adobe.com/es/experience-manager/dispatcher/using/dispatcher-install.html#ApacheWebServer) </b>(Específico del servidor web Apache) para servir páginas de error como las 404 desde la caché de Dispatcher.
...
7. <b>Activar [/serveStaleOnError](https://helpx.adobe.com/es/experience-manager/kb/ServeStaleContentOnError.html)</b> AEM en la configuración /cache: sirva el archivo de caché antiguo cuando las instancias de muestren errores.
...
Una explicación más detallada del vaciado de recuperación
